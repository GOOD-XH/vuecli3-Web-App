      ...
      <div class="list-wrapper" @click.stop>
        ...
        <scroll ref="listContent" class="list-content" :data="sequenceList" :refreshDelay="refreshDelay">
          <transition-group ref="list" name="list" tag="ul">
            <li :key="index" class="item" ref="listItem" v-for="(item,index) in sequenceList"
...
export default {
  ...
  methods: {
    ...
    //删除
    deleteOne(item) {
      this.$store.dispatch('_deleteSong', item)
      //当全部删除后，隐藏
    ...
    //清空
    confirmClear() {
      this.$store.dispatch('_deleteSonglist')
      this.hide()
    }
  },
  watch: {
